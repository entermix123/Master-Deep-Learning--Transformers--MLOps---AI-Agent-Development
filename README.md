# This repository is for Udemy course AI Engineer Professional Certificate Course - https://www.udemy.com/course/ai-engineer-professional-certificate-course/?couponCode=26BBPAAO2MX
...
- Day 3: Advance Hyperparameter Runing with Bayesian Optimization
...
- Day 3: Pooling Layers and Dimensionality Filters
- Day 4: Building CNN Architectures with Keras and TensorFlow
- Day 5: Building CNN Architecture with PyTorch
...
- Day 2: Understanding RNNs Architecture and Backpropagation Through Time (BPTT)
- Day 3: Long Short-Term Memory (LSTM) Networks
- Day 4: Gated Recurrent Units (GRUs)
- Day 5: Text Processing and Word Embeddings for RNNs
...
- Day 5: Hand-On with Pre-Trained Transformers - BERT and GPT
...
- Day 6: Domain Adoption and Transfer Learning Challenges
- Day 7: Transfer Learning Project - Fine-Tuning for a Custom Task


## AI Agents: A Comprehensive Overview

- Hand-on AutoGen | IBM Bee | LangGraph | CrewAI | AutoGPT
- Hand-on AutoGen
- Hand-on IBM Bee
- Hand-on LangGraph
- Hand-on CrewAI
...
## Introduction and Hand-on MLOps

- Introduction to MLOps Session
...
- Hand-on: Set up a basic MLOps Project Structure (Git, Docker, Model Pipeline)
...
- Hands-on: Build and end-to-end pipeline for an ML model
...
- Setting up Local MLOps Environment
- Hand on: Containerize a simple ML Model and deploy it locally using Kubernetes
